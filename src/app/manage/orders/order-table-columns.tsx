...
const orderTableColumns: ColumnDef<OrderItem>[] = [
    ...
    cell: function Cell({ row }) {
      ...
      const changeOrderStatus = async (
        ...
        changeStatus({
          ...
          dishId: row.original.dishSnapshot.dishId!, // dishId này có thể null vì dish có thể bị xóa nên ta phải đảm bảo bằng cách thêm !
          status: status,
  ...
  {
    id: "orderHandlerName",
    header: () => <div className="hidden md:table-cell">Người xử lý</div>,
    cell: ({ row }) => (
      <div className="hidden md:table-cell">
        {row.original.orderHandler?.name ?? ""}
      </div>
    ),
  },
  {
